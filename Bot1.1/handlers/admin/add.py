...
@dp.callback_query_handler(IsAdmin(), text="add_sub_category")
async def add_subcategory_callback_handler(query: CallbackQuery):
    await query.message.delete()
    await query.message.answer("Название подкатегории?")
